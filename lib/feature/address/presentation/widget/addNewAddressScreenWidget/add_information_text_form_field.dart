              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null ||
                          ...
                          !AppRegex.isNameValid(value)) {
                        return context.translate(
                          AppStrings.pleaseEnterAValidStreetName,
                        );
                      }
                      return null;
                    },
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: context.translate(
                        AppStrings.additionalDirectionsOptional,
                      ),
                    ),
                  ),
                  SizedBox(height: 10.h),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: context.translate(
                        AppStrings.addressLabelOptional,
                      ),
                    ),
                  ),
                  SizedBox(height: 10.h),
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.titleMedium!.copyWith(fontSize: 10.5.sp),
                    ),
                  ),
                  CustomButton(
                    onPressed: () async {
  ...
  state.whenOrNull(
    ...
    createNewAddressSuccess: (data) {
      ...
      if (context.mounted) {
        ...
        context.read<MapCubit>().textEditingSearchText = context.translate(
          AppStrings.findYourLocation,
        );

        if (userAddressCubit.isPaymentAddress == true) {
          final index = userAddressCubit.addressDataList.indexWhere(
            (element) => element.sId == data.data!.sId,
          );

          if (index != -1) {
            context.read<UserAddressCubit>().changeBetweenAddress(index);
          ...
          context.pop();
          context.pushReplacementNamed(Routes.address);
        }
      }
    },
