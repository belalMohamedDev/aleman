...
class OrderDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: _orderDetailsAppBar(context, responsive, isEnLocale),
    ...
    showCupertinoModalBottomSheet(
      ...
      builder: (context) => SizedBox(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Image.asset(ImageAsset.basket, height: responsive.setHeight(8)),
              ...
              CustomButton(
                onPressed: () {
                  final orderId =
                      order?.sId ?? paymentCubit.createOrderResponseData?.sId;
                  if (orderId != null) {
                    paymentCubit.orderCancelSummit(orderId);
                  }
                },
                widget: Text(
                  context.translate(AppStrings.yesCancel),
              ...
              CustomButton(
                ...
                widget: Text(
                  context.translate(AppStrings.noKeepIt),
                  style: Theme.of(context).textTheme.titleLarge!.copyWith(
                    fontSize: responsive.setTextSize(4),
                  ),
                ),
