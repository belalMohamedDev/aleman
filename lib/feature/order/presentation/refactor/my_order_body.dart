        ...
        Padding(
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: [
                Tab(text: context.translate(AppStrings.currentOrders)),
                ...
                builder: (context, state) {
                  if (state is GetCompleteOrdersSuccess) {
                    if (context
                        ...
                        .getPerviousOrders
                        .isEmpty) {
                      return const EmptyOrderScreen(isCurrentOrder: false);
                    }
                    return OrdersTab(
                      getOrdersResponseData: context
                          .read<PaymentCubit>()
  ...
  Container _cardItemLoading() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          SizedBox(width: 10.w),
          Image.asset(ImageAsset.picture, height: 40.h),
          SizedBox(width: 10.w),
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              LoadingShimmer(height: 4.h, width: 220.w, borderRadius: 12.r),
              SizedBox(height: 10.h),
              LoadingShimmer(height: 4.h, width: 140.w, borderRadius: 12.r),
              SizedBox(height: 10.h),
              LoadingShimmer(height: 4.h, width: 80.w, borderRadius: 12.r),
            ],
          ),
        ],
      ),
