...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<BannerResponse> getBannersService(
    Map<String, dynamic> requestQuary,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<BannerResponse> updateImageBannerService(String id, File image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  @override
  Future<ProductResponse> getAllProductService(int? limit, int? page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<ProductResponse> createProductService(
    ...
    _data.fields.add(MapEntry('title.ar', arTitle));
    _data.fields.add(MapEntry('title.en', enTitle));
    _data.fields.add(MapEntry('subCategory', subCategory));
    _data.fields.add(MapEntry('description.en', enDescription));
    _data.fields.add(MapEntry('description.ar', arDescription));
  ...
  @override
  Future<BranchStoreAddressResponse> getAllBranchStoreAddressService() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<AuthResponse> deleteAdminService(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<CreateAddressResponse> createAddressService(
    ...
    final _options = _setStreamType<CreateAddressResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/api/address',
  ...
  Future<CheckLocationAvailableResponse> checkAddressAvaliableService(
    ...
    final _options = _setStreamType<CheckLocationAvailableResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<GetAddressResponse> getAllAddressService() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAddressResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/api/address',
  ...
  Future<GetProductsBasedOnCategory> getProductsBasedOnCategory(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetProductsBasedOnCategory>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<UpdateAccountInformationResponse> updateMyData(
    ...
    final _options = _setStreamType<UpdateAccountInformationResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<UpdateEmailAddressResponse> updateMyEmailAddress(
    ...
    final _options = _setStreamType<UpdateEmailAddressResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<UserNotificationResponse> getAllNotificationToUserService() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserNotificationResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  getOrdersStatusAndSalesTodayCountService() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetOrderStatusCountResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<CouponsResponse> getAllCouponsService() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CouponsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/api/coupon',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CouponsResponse _value;
    try {
      _value = CouponsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CouponsResponse> updateCouponService(
    ...
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = {'title': title, 'discount': discount, 'expire': expire};
    _data.removeWhere((k, v) => v == null);
    final _options = _setStreamType<CouponsResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
  ...
  @override
  Future<ApiSuccessGeneralModel> deleteCouponService(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
